...
q3 |> 
  mutate('5-year running average' = slide_mean(Mean_Average, before = 4, complete = TRUE),
    '10-year running average' = slide_mean(Mean_Average, before = 9, complete = TRUE),
    '20-year running average' = slide_mean(Mean_Average, before = 19, complete = TRUE))
```
**Question 8:**
